...
import ru.nsu.ccfit.kanterov.yall.interpreter.operation.MultiplyOperation;
...
public class MultiplyFunction extends ArithmeticalFunction {
    public MultiplyFunction(Token function, List<Tree> children) throws Parser.ParseException {
    ...
    public void build(ProgramBuilder programBuilder) {
        ...
        programBuilder.addOperation(new MultiplyOperation());
    }
}
