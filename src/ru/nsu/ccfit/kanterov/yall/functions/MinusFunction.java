...
import ru.nsu.ccfit.kanterov.yall.interpreter.operation.MinusOperation;
...
public class MinusFunction extends ArithmeticalFunction {
    public MinusFunction(Token function, List<Tree> children) throws Parser.ParseException {
    ...
    public void build(ProgramBuilder programBuilder) {
        ...
        programBuilder.addOperation(new MinusOperation());
    }
}
