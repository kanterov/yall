...
public class GreaterFunction extends ArithmeticalFunction {
    public GreaterFunction(Token function, List<Tree> children) throws Parser.ParseException {
    ...
    public void build(ProgramBuilder programBuilder) {
        ...
        programBuilder.addOperation(new ConditionalOperation(ConditionalOperation.Condition.GR));
    }
}
